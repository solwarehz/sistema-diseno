...
export { RangoFecha, ATAJOS_POR_OMISION, atajosDeDias, type AtajoRango, type RangoFechaProps } from './RangoFecha';
...
export { PanelPrivilegios, resumirPrivilegios, privilegiosEfectivos, claveNivel, comoNoRepartible, baseDe, baseSinResolver,
