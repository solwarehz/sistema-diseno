...
| **9** | **Obligatorio.** (R46, v1.40.0) El panel lleva **dos botones, nunca uno que cambie de significado**. «Grabar» nace apagado y se enciende con contenido válido; «Cancelar» **siempre está y nunca se apaga** — es la salida cuando el archivo no vale, y sin ella se quedaba encerrado. Un solo botón que pasara de «Cancelar» a «Guardar» cambiaría lo que hace bajo el cursor. |
