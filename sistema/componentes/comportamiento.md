...
| **8** | **Obligatorio.** (R50, v1.44.0) La columna **se centra sobre su caja**: rótulo, vista previa y botón caen sobre el mismo eje. Alineados a la izquierda, los tres miden distinto y salía una escalera. |
...
| **10** | Del proyecto: **qué dice la nota, y que sea corta.** El sistema decide cuándo se ve; la redacción es de cada aplicación. Tres frases no caben debajo de una vista previa de 96px. |
