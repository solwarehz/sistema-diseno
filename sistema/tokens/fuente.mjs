...
export const CAMBIOS = [
  {
    ...
    porque:
      ...
      + 'y decide el orden. '
      + 'OCHO REGLAS NUEVAS DE CONTRATO —18 a 25— CON 46 PRUEBAS, y las tres ultimas las escribieron '
      ...
      + 'interruptor ENCENDIDO. Se paso de 13 pruebas a 46 y se volvieron a mutar una a una. '
