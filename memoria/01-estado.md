...
**Versión del sistema:** MMI-DS **v1.104.0** — R124: los siete iconos de
...
| Componentes de React | ✅ | **625 pruebas en 42 archivos** · `tsc --noEmit` limpio |
...
| Entrega ZIP | ✅ | `sistema-diseno-v1.104.0.zip` · **56 archivos** · se publica con `npm run publicar` |
| Modo oscuro | ✅ | Aprobado 2026-08-09 · marco en escala de negros |
| Manual de aplicaciones | ✅ | **v1.3.0 sobre MMI-DS v1.58.0** · §5.5 manda a los componentes en vez de describir su anatomía |
| Guía de actualización | ✅ | `ACTUALIZAR.md` en **v1.104.0**, con el salto **desde la v1.19.0**, que es la instalada |
