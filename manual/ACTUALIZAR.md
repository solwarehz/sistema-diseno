# Actualizar al sistema de diseño v1.133.0
...
**<https://github.com/solwarehz/sistema-diseno/releases/tag/v1.133.0>**

O desde la línea de órdenes:

```bash
gh release download v1.133.0 --repo solwarehz/sistema-diseno
```
