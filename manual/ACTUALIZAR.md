# Actualizar al sistema de diseño v1.10.5
...
```bash
npm install "github:solwarehz/sistema-diseno#v1.10.5"
```

**La etiqueta es obligatoria.** Sin `#v1.10.5` npm instala la rama por omisión,
...
```bash
node -p "require('sistema-diseno-ae/package.json').version"   # 1.10.5
```
...
Esa es la razón de las 3.983 líneas que costó la tabla. **Desde la v1.10.5
