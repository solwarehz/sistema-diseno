# Actualizar al sistema de diseño v1.13.1
...
```bash
npm install "github:solwarehz/sistema-diseno#v1.13.1"
```
...
Esa es la razón de las 3.983 líneas que costó la tabla. **Desde la v1.13.1
