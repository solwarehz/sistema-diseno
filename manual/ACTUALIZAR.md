# Actualizar al sistema de diseño v1.15.0
...
```bash
npm install "github:solwarehz/sistema-diseno#v1.15.0"
```
...
Esa es la razón de las 3.983 líneas que costó la tabla. **Desde la v1.15.0
