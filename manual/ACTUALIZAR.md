# Actualizar al sistema de diseño v1.58.1
...
```bash
npm install "github:solwarehz/sistema-diseno#v1.58.1"
```
...
```bash
node -p "require('sistema-diseno-ae/package.json').version"   # 1.58.1
```
...
**<https://github.com/solwarehz/sistema-diseno/releases/tag/v1.58.1>**

O desde la línea de órdenes:

```bash
gh release download v1.58.1 --repo solwarehz/sistema-diseno
```
...
> saltó al comprobarlo. Lo que hay es **v1.38.0 y anteriores**, y **v1.58.1**.
